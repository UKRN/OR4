...
\section{OR4 toolkit overview}\label{or4-toolkit-overview}
...
\item
  ...
  assessment, planning and progress. The guide is illustrated with case
  studies from institutions that have participated in the OR4 project. A
  \href{glossary.qmd}{Glossary of key terms} is included.
\end{itemize}

The maturity framework and the linked guide are organised in nine action
areas under three themes, as follows:

\paragraph{Strategy and leadership}\label{strategy-and-leadership}
...
\paragraph{Managing progress}\label{managing-progress}
...
\subsection{How to use the toolkit}\label{how-to-use-the-toolkit}
