...
The **Recognising and rewarding open research** toolkit consists of three main components:
...
- an [implementation guide](guide-contents.qmd) consisting of an introduction and sections linked to corresponding action areas in the maturity framework, providing detailed practical guidance to support assessment, planning and progress. The guide is illustrated with [case studies](case-studies.qmd) that exemplify different aspects of institutional activity. A [glossary of key terms](glossary.qmd) is included.

- a [suggested action table](suggested-action-table.qmd) summerising, for each section of the framework, the actions that OR4 member institutions have taken to progress to the next level of maturity.
...
The suggested action table can provide inspiration for action planning. It summerises the actions that the OR4 Community of Prcatice Instutions have taken in each area.
