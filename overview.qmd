...
- a [maturity framework and self-assessment tool](https://recognition.ukrn-openresearch.ac.uk/maturity-framework.html) that institutions can use to assess their maturity in the implementation of relevant policies and procedures, to support internal discussion and planning, and to measure ongoing progress; 

- an [implementation guide](https://recognition.ukrn-openresearch.ac.uk/guide-contents.html) consisting of an introduction and sections linked to corresponding action areas in the maturity framework, providing detailed practical guidance to support assessment, planning and progress. The guide is illustrated with [case studies](https://recognition.ukrn-openresearch.ac.uk/case-studies.html) from institutions that have participated in the OR4 project. A [glossary of key terms](https://recognition.ukrn-openresearch.ac.uk/glossary.html) is included.
...
An assessment undertaken using the maturity framework and the self-assessment tool will generate an overall picture of institutional maturity across all nine action areas at a given point in time. It can enable a [group of stakeholders](https://recognition.ukrn-openresearch.ac.uk/glossary.html#stakeholder-group) to establish a baseline, identify and focus on the target level of maturity in each action area, plan the means by which this target can be attained, and in due course measure progress.
