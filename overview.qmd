...
The implementation guide can be used to develop a shared understanding of the rationale for recognising and rewarding open research practice and to explore different aspects of implementation in greater depth, in order so support informed planning and implementation.

The toolkit is organised broadly according to the logic of implementation, which might begin with an institutional commitment to implement recognition and reward for open research and conclude with business-as-usual operations being established under ongoing oversight. The logic is not necessarily linear: in practice, actions in different areas may be more or less co-ordinated, and may be concurrent or undertaken at different times and in different sequences. Institutions will have different starting points and different objectives. The framework is not meant to prescribe a single route to a fixed destination, but to facilitate the development of a plan adapted to the needs of the institution. 

[Graphic links to MF page and Toolkit contents page]
