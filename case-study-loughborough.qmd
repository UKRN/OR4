...
[Template for weighted menu of evidence](https://recognition.ukrn-openresearch.ac.uk/resources/EON-weightedmenutemplate.xlsx) (xlsx) – Lists and scores types of evidence for others to use 
...
[Pilot Feedback Survey](https://forms.office.com/Pages/DesignPageV2.aspx?origin=ShareFormPage&subpage=design&m2=1&id=xDv6T_zswEiQgPXkP_kOX2AR4He8fG5KniSSJC9eBTFUOU84RVIyVUFGMzlTMVhNVzU1WUkyTkxOVC4u) (Forms)– Used to gather participant views on the draft guidance and evidence menu.

[Pilot Feedback Survey](https://recognition.ukrn-openresearch.ac.uk/resources/EON-feedbackform.pdf){:target="_blank"} (PDF)
